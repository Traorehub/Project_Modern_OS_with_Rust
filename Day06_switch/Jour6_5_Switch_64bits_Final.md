...
/home/kali/Day07/OS_Day7/run_tests.sh \
...
[target.x86_64-unknown-none]
rustflags = [
    "-C", "link-arg=-T/home/kali/Day07/OS_Day7/linker.ld",
    "-C", "linker=rust-lld",
    "-C", "opt-level=z",
    "-C", "panic=abort",
    "-C", "code-model=kernel",
...
runner = "/home/kali/Day07/OS_Day7/run_tests.sh"
```
...
dd if=/home/kali/Day07/OS_Day7/boot.bin of="$IMG" conv=notrunc 2>/dev/null

# Secteur 2 : stage2 (transition 32→64 bits)
dd if=/home/kali/Day07/OS_Day7/stage2.bin of="$IMG" bs=512 seek=1 conv=notrunc 2>/dev/null
