; Jour 17 : recopie le kernel a sa taille REELLE (lue dans le MBR a 0x7DF4),
; depuis le tampon 0x10000 (charge en LBA par boot.asm) vers 0x200000.
BITS 32
ORG 0x8000
...
mode32:
    ...
    ; 0x7C00 + 500 = 0x7DF4 : kernel_bytes (u32 LE), patche par le build.
    mov ecx, [0x7DF4]
    add ecx, 3
    shr ecx, 2
    test ecx, ecx
