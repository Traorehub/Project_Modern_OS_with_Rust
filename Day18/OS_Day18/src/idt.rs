...
use crate::{serial, gdt, vga, vga2, keyboard, pic, timer, scheduler};
...
/// Handler IRQ0 : tick, EOI, puis eventuellement `schedule()`.
/// L'EOI vient AVANT le switch : sinon IRQ0 resterait masquee tant que
/// la tache preemptée n'a pas repris le handler.
/// Toujours aucun verrou VGA ici.
