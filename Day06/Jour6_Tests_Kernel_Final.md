...
```toml
"-C", "link-arg=-T/home/kali/Day06/OS_Day6/linker.ld",
```
...
runner = "/home/kali/Day06/OS_Day6/run_tests.sh"
```
...
dd if=/home/kali/Day06/OS_Day6/boot.bin of="$IMG" conv=notrunc 2>/dev/null
...
mkdir -p /home/kali/Day06/OS_Day6/tests/src
