...
mode32:
    ...
    ; CR4 : PAE (bit 5) obligatoire pour le long mode
    ;     + OSFXSR (bit 9) et OSXMMEXCPT (bit 10) pour autoriser SSE.
    ; Sans OSFXSR, toute instruction SSE leve #UD — et la cible
    ; x86_64-unknown-none active SSE2 par defaut, donc LLVM en emet.
    mov eax, cr4
    or eax, 0x620
    mov cr4, eax
