...
use crate::{serial, gdt, vga, vga2, keyboard, pic, timer};
...
pub fn init() {
    unsafe {
        ...
        // IRQ0 (timer PIT) remappee a l'interruption 32 (32 + 0) — Jour 16
...
/// Handler IRQ0 — Jour 16.
/// Volontairement minimal : on incremente un compteur atomique et on acquitte.
/// Pas de println!, pas de verrou VGA : ce handler peut interrompre la boucle
/// principale a n'importe quel instant, y compris pendant qu'elle detient le Mutex.
